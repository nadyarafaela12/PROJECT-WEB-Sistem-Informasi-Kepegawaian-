...
<head>
  ...
  <title>SIMPEG Sekolah Dasar Swasta Muhammadiyah</title>
...
<body>
  <nav class="red accent-3" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo"><b>SIMPEG</b><small style="font-size: 19px;"> SD Swasta Muhammadiyah</small></a>      
    ...
    <ul class="slides">
      <li>
        ...
        <div class="caption center-align">
          <h3>Sekolah Dasar Swasta Muhammadiyah</h3>
      ...
      <li>
        ...
        <div class="caption left-align">
          ...
          <h5 class="light grey-text text-lighten-3">Sekolah Dasar Swasta Muhammadiyah</h5>
        </div>
      </li>
      <li>
      ...
      <li>
        ...
        <div class="caption center-align">
          <h3>AYOO .. BELAJAR...!</h3>
          <h5 class=" text-black">Sekolah Dasar Swasta Muhammadiyah</h5>
        </div>
      </li>
    </ul>
...
if ($page=='home') {
  ...
  <h3>Sistem Informasi Kepegawaian</h3>
  <h4>Sekolah Dasar SwastaMuhammadiyah</h4>
</center>";
  # code...
}elseif ($page=='profil') {
  echo "PROFIL";
...
elseif ($page=='') {
  ...
  <h3>Sistem Informasi Kepegawaian</h3>
  <h4>Sekolah Dasar Swasta Muhammadiyah</h4>
</center>";
  # code...
}else{
  echo "404 Not Found";
      ...
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="white-text text-lighten-4">
            <b>SIMPEG</b> Adalah Sistem Informasi Kepegawaian Sekolah yang dibangun menggunakan Framework Bootstrap, dan Pemrograman PHP/MySQL . <br>
            <b>SIMPEG</b> dapat digunakan untuk mengolah data kepegwaian sekolah, agar pengelolaan data dibidang kepegawaian sekolah dapat berjalan dengan baik dan efesien.
          </p>
